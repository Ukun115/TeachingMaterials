...
namespace SOLID.SingleResponsibility.Shared
{
    /// <summary>
    ...
    public class BattleLogUI : MonoBehaviour
    {
        ...
        private void BuildUI()
        {
            ...
            Stretch(title, 24, 24, 24, 24);
            title.anchorMin = new Vector2(0f, 1f);
            title.anchorMax = new Vector2(1f, 1f);
            title.pivot = new Vector2(0.5f, 1f);
            title.sizeDelta = new Vector2(-48, fontSize + 12);
            ...
            _titleText.text = "SRP 悪い例：神クラスCharacterのバトルログ";
