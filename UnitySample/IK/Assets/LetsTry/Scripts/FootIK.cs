namespace IK
{
    ...
    public class FootIK : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // STEP1: 足の自然な高さから地面までの距離を計算してfootOffsetに保存

        }

        /// <summary>
        /// STEP2: IKの計算が行われるたびに呼ばれるコールバック関数OnAnimatorIKを実装
        ...
        {
            // STEP5: 足の位置に応じてのIKの重み計算

            // TODO: 下記return 0;は仮の値なので、実際できたら削除する。
            return 0;
        }
